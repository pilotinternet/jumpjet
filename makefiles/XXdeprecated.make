;
; These modules are expected to be removed from Jumpjet in the future
; They are only here to support older sites built on previous jumpjet installs
; But in future you may have to manually install them, or adapt your site



; ============================================================================== Modules - Newspaper suite
; This suite started in a very promising way - but doesn't seem to be
